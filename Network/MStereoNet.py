...
class MSNet(nn.Module):
    ...
    def forward(self, left_img, right_img):
        ...
        def feature_extraction(img):
            ...
            # print('Pre Pyramid', img.shape)

            # img = self.pyramidpool(img)
            # print('Pos Pyramid', img.shape)
            ...
            # print('Size::', output_feature.size())
        ...
        # print('DISP::size():', disparity.size())
